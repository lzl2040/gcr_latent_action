...
class Modified_ExpertQKV_SanaAttnProcessor2_0:
    ...
    def __call__(
        ...
        key_video = attn.to_k_video(encoder_hidden_states_video)
        value_video = attn.to_v_video(encoder_hidden_states_video)
...
class Modified_SanaVideoTransformerBlock_V2(SanaVideoTransformerBlock):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.attn2.to_q_video = nn.Linear(self.attn2.query_dim, self.attn2.inner_dim, bias=True)
        self.attn2.to_k_video = nn.Linear(self.attn2.cross_attention_dim, self.attn2.inner_kv_dim, bias=True)
        self.attn2.to_v_video = nn.Linear(self.attn2.cross_attention_dim, self.attn2.inner_kv_dim, bias=True)
