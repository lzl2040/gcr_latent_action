...
@PreTrainedConfig.register_subclass("latent_wm")
@dataclass
class LatentWorldModelConfig(PreTrainedConfig):
    ...
    video_pred_model: str = "/mnt/wangxiaofa/pt_weights/SANA-Video_2B_480p_diffusers"
    ...
    def __post_init__(self):
        super().__post_init__()
        self.new_tokens.extend(["<CP_SC>", "<CP_ACT>"])
