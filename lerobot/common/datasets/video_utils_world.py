...
def decode_video_frames_torchcodec(
    ...
    worker_count: int = 1,
    max_future_num: int = -1,
    max_history_num: int = -1
):
    ...
    if not return_all and max_future_num < 0 and max_history_num < 0:
        ...
        if max_history_num > 0:
            ...
            assert len(history_frame_list) != 0, f"{max_ts} current frame:{max_tx_frame} total frame:{total_frames}"
    ...
    if return_type == "tensor":
        ...
        return image_list, history_frame_num
    else:
