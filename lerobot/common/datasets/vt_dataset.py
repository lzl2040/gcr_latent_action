...
from lerobot.common.datasets.transforms import build_transform
...
class MultiDatasetforDistTraining(torch.utils.data.Dataset):
    ...
    def _prepare_intern_vl_data(self, item):
        ...
        # cp_img_token_num = torch.sum(input_ids == self.cp_img_token_idx)
        # print("image token:", cp_img_token_num)
        return return_dict
