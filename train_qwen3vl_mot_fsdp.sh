...
export FSDP_CHECKPOINT_SYNC_FILES="${FSDP_CHECKPOINT_SYNC_FILES:-false}"
export FSDP_CHECKPOINT_THREADS="${FSDP_CHECKPOINT_THREADS:-1}"
export FSDP_CHECKPOINT_HEARTBEAT_SECONDS="${FSDP_CHECKPOINT_HEARTBEAT_SECONDS:-60}"
require_positive_int "DISTRIBUTED_TIMEOUT_MINUTES" "$DISTRIBUTED_TIMEOUT_MINUTES"
require_bool "FSDP_CHECKPOINT_SYNC_FILES" "$FSDP_CHECKPOINT_SYNC_FILES"
require_positive_int "FSDP_CHECKPOINT_THREADS" "$FSDP_CHECKPOINT_THREADS"
require_nonnegative_int \
